...
const driverShafts: Shaft[] = [
  ...
  },
  {
    ...
    speedRange: [41, 52],
    trajectory: "ニュートラル",
    comment: "VENTUS Blue系の安定感を基準に、幅広いヘッドへ合わせやすい診断用設定。",
    sourceName: "Fujikura 24 VENTUS",
    sourceUrl: "https://www.fujikurashaft.jp/en/en_material/en_ventus/24ventus/",
  },
  {
    name: "24 VENTUS Red",
    weight: "50g / 60g台",
    ...
    speedRange: [38, 48],
    trajectory: "ドロー寄り",
    comment: "高さとつかまりを補いながら、VENTUSらしい方向安定性を狙う診断用設定。",
    sourceName: "Fujikura 24 VENTUS",
    sourceUrl: "https://www.fujikurashaft.jp/en/en_material/en_ventus/24ventus/",
  },
  {
    name: "24 VENTUS Black",
    weight: "60g / 70g台",
    torque: 3.1,
    tipStiffness: 88,
    midStiffness: 82,
    ...
    speedRange: [45, 56],
    trajectory: "フェード寄り",
    comment: "強く叩いても左と吹け上がりを抑えたい人向けの診断用ハード設定。",
    sourceName: "Fujikura 24 VENTUS",
    sourceUrl: "https://www.fujikurashaft.jp/en/en_material/en_ventus/24ventus/",
  },
  {
    ...
    speedRange: [42, 53],
    trajectory: "ニュートラル",
    comment: "Blueの振りやすさにねじれ剛性を足し、曲がり幅を抑える診断用設定。",
    sourceName: "Fujikura VENTUS TR",
    sourceUrl: "https://www.fujikurashaft.jp/en/en_material/en_ventus/ventus_tr/",
  },
  {
    name: "VENTUS TR Red",
    weight: "50g / 60g台",
    ...
    speedRange: [40, 50],
    trajectory: "ドロー寄り",
    comment: "つかまりと打ち出しを確保しつつ、過度な暴れを抑える診断用設定。",
    sourceName: "Fujikura VENTUS TR",
    sourceUrl: "https://www.fujikurashaft.jp/en/en_material/en_ventus/ventus_tr/",
  },
  {
    name: "VENTUS TR Black",
    weight: "60g / 70g台",
    torque: 3.0,
    tipStiffness: 90,
    midStiffness: 84,
    ...
    speedRange: [46, 57],
    trajectory: "フェード寄り",
    comment: "低打ち出し・低スピンで、強い入力に負けない診断用設定。",
    sourceName: "Fujikura VENTUS TR",
    sourceUrl: "https://www.fujikurashaft.jp/en/en_material/en_ventus/ventus_tr/",
  },
  {
    name: "SPEEDER NX VIOLET",
    weight: "40g / 50g / 60g / 70g台",
    torque: 4.5,
    tipStiffness: 66,
    midStiffness: 64,
    buttStiffness: 70,
    ...
    speedRange: [36, 48],
    trajectory: "ドロー寄り",
    comment: "中調子の振りやすさと高弾道を重視する診断用スピード系設定。",
    sourceName: "Fujikura SPEEDER NX VIOLET",
    sourceUrl: "https://www.fujikurashaft.jp/material/speeder/speeder_nx_violet/",
  },
  {
    name: "SPEEDER NX BLACK",
    weight: "40g / 50g / 60g / 70g台",
    torque: 4.0,
    tipStiffness: 70,
    midStiffness: 68,
    ...
    speedRange: [38, 50],
    trajectory: "ドロー寄り",
    comment: "先中調子の走り感を残しながら、インパクトの安定感を狙う診断用設定。",
    sourceName: "Fujikura SPEEDER NX BLACK",
    sourceUrl: "https://www.fujikurashaft.jp/en/en_material/en_speeder/speeder_nx/",
  },
  {
    name: "SPEEDER NX GREEN",
    weight: "40g / 50g / 60g / 70g台",
    torque: 3.8,
    tipStiffness: 72,
    midStiffness: 70,
    ...
    speedRange: [39, 51],
    trajectory: "ニュートラル",
    comment: "走り感と方向性のバランスを取りたい人向けの診断用設定。",
    sourceName: "Fujikura SPEEDER",
    sourceUrl: "https://www.fujikurashaft.jp/material/speeder/?vm=r",
  },
  {
    name: "SPEEDER NX GOLD",
    weight: "40g / 50g / 60g台",
    torque: 4.2,
    tipStiffness: 68,
    midStiffness: 66,
    ...
    speedRange: [37, 49],
    trajectory: "ドロー寄り",
    comment: "つかまりと飛距離感を補いたい中速域向けの診断用設定。",
    sourceName: "Fujikura SPEEDER",
    sourceUrl: "https://www.fujikurashaft.jp/material/speeder/?vm=r",
  },
  {
    ...
    speedRange: [30, 40],
    trajectory: "ドロー寄り",
    comment: "軽量で振り切りやすく、高さとつかまりを補う診断用設定。",
    sourceName: "Fujikura SPEEDER",
    sourceUrl: "https://www.fujikurashaft.jp/material/speeder/?vm=r",
  },
  {
    name: "Speeder SLK Type-D",
    weight: "40g / 50g台",
    torque: 5.2,
    tipStiffness: 58,
    midStiffness: 60,
    ...
    speedRange: [34, 44],
    trajectory: "ドロー寄り",
    comment: "短尺やミート率重視の組み方で、つかまりを出しやすい診断用設定。",
    sourceName: "Fujikura SPEEDER",
    sourceUrl: "https://www.fujikurashaft.jp/material/speeder/?vm=r",
  },
  {
    ...
    speedRange: [43, 55],
    trajectory: "フェード寄り",
    comment: "左を抑えた強弾道を狙う、叩ける方向の診断用設定。",
    sourceName: "Graphite Design TOUR AD",
    sourceUrl: "https://graphitedesign.gd-inc.co.jp/tourad/",
  },
  {
    name: "Tour AD CQ",
    weight: "40g / 50g / 60g / 70g台",
    ...
    speedRange: [37, 48],
    trajectory: "ドロー寄り",
    comment: "つかまりと高弾道を足したい時の診断用Tour AD設定。",
    sourceName: "Graphite Design TOUR AD",
    sourceUrl: "https://graphitedesign.gd-inc.co.jp/tourad/",
  },
  {
    ...
    speedRange: [41, 53],
    trajectory: "フェード寄り",
    comment: "中元系のしっかり感で、低スピン寄りにまとめる診断用設定。",
    sourceName: "Graphite Design TOUR AD",
    sourceUrl: "https://graphitedesign.gd-inc.co.jp/tourad/",
  },
  {
    ...
    speedRange: [43, 55],
    trajectory: "フェード寄り",
    comment: "手元側の粘りと先端の強さで、左と吹けを抑える診断用設定。",
    sourceName: "Graphite Design TOUR AD",
    sourceUrl: "https://graphitedesign.gd-inc.co.jp/tourad/",
  },
  {
    ...
    speedRange: [39, 50],
    trajectory: "ドロー寄り",
    comment: "しなり戻りを使って球を押し出しやすい診断用設定。",
    sourceName: "Graphite Design TOUR AD",
    sourceUrl: "https://graphitedesign.gd-inc.co.jp/tourad/",
  },
  {
    ...
    speedRange: [40, 52],
    trajectory: "ニュートラル",
    comment: "振り抜きやすさと安定感を両立しやすい診断用設定。",
    sourceName: "Graphite Design TOUR AD",
    sourceUrl: "https://graphitedesign.gd-inc.co.jp/tourad/",
  },
  {
    ...
    speedRange: [41, 53],
    trajectory: "ニュートラル",
    comment: "クセを抑えた中弾道で、ヘッド特性を活かす診断用設定。",
    sourceName: "Graphite Design TOUR AD",
    sourceUrl: "https://graphitedesign.gd-inc.co.jp/tourad/",
  },
  {
    ...
    speedRange: [41, 53],
    trajectory: "ニュートラル",
    comment: "直進性を重視しつつ、極端すぎない弾道に整える診断用設定。",
    sourceName: "Graphite Design TOUR AD",
    sourceUrl: "https://graphitedesign.gd-inc.co.jp/tourad/",
  },
  {
    ...
    speedRange: [39, 51],
    trajectory: "ニュートラル",
    comment: "現代ヘッドに合わせて、振りやすさと初速感を狙う診断用設定。",
    sourceName: "Graphite Design TOUR AD",
    sourceUrl: "https://graphitedesign.gd-inc.co.jp/tourad/",
  },
  {
    name: "Diamana WB",
    weight: "40g / 50g / 60g / 70g / 80g台",
    torque: 3.2,
    tipStiffness: 86,
    midStiffness: 80,
    buttStiffness: 84,
    ...
    speedRange: [44, 56],
    trajectory: "フェード寄り",
    comment: "白マナ系の左を抑える強さを想定した診断用設定。",
    sourceName: "Mitsubishi Chemical Diamana",
    sourceUrl: "https://www.mitsubishichemicalgolf.jp/products/series/?id=2",
  },
  {
    name: "Diamana BB",
    weight: "40g / 50g / 60g / 70g / 80g台",
    ...
    speedRange: [40, 52],
    trajectory: "ニュートラル",
    comment: "青マナ系の素直な中弾道を基準にした診断用設定。",
    sourceName: "Mitsubishi Chemical Diamana",
    sourceUrl: "https://www.mitsubishichemicalgolf.jp/products/series/?id=2",
  },
  {
  ...
  },
  {
    ...
    speedRange: [43, 55],
    trajectory: "フェード寄り",
    comment: "低スピン系ヘッドでも左を抑えて強く振るための診断用設定。",
    sourceName: "Mitsubishi Chemical Diamana",
    sourceUrl: "https://www.mitsubishichemicalgolf.jp/products/series/?id=2",
  },
  {
    ...
    speedRange: [39, 51],
    trajectory: "ニュートラル",
    comment: "タイミングを取りやすい中調子寄りとして扱う診断用設定。",
    sourceName: "Mitsubishi Chemical Diamana TB",
    sourceUrl: "https://www.mitsubishichemicalgolf.jp/pdf/MCC_jp_1594014781.pdf",
  },
  {
    name: "Diamana ZF",
    weight: "40g / 50g / 60g / 70g / 80g台",
    ...
    speedRange: [42, 54],
    trajectory: "フェード寄り",
    comment: "低めの中弾道で、過度なつかまりを抑える診断用設定。",
    sourceName: "Mitsubishi Chemical Diamana",
    sourceUrl: "https://www.mitsubishichemicalgolf.jp/products/series/?id=2",
  },
  {
    name: "TENSEI Pro Blue 1K",
    weight: "50g / 60g / 70g / 80g台",
    torque: 3.5,
    tipStiffness: 74,
    midStiffness: 70,
    buttStiffness: 76,
    ...
    speedRange: [40, 53],
    trajectory: "ニュートラル",
    comment: "Blue系の振りやすさと安定性を両立する診断用設定。",
    sourceName: "Mitsubishi Chemical TENSEI",
    sourceUrl: "https://www.mitsubishichemicalgolf.jp/products/series/?id=3",
  },
  {
    name: "TENSEI Pro White 1K",
    weight: "50g / 60g / 70g / 80g台",
    torque: 3.1,
    tipStiffness: 86,
    midStiffness: 80,
    ...
    speedRange: [45, 57],
    trajectory: "フェード寄り",
    comment: "元調子の強さで低打ち出し・低スピンを狙う診断用設定。",
    sourceName: "Mitsubishi Chemical TENSEI",
    sourceUrl: "https://www.mitsubishichemicalgolf.jp/products/series/?id=3",
  },
  {
    name: "TENSEI Pro Orange 1K",
    weight: "50g / 60g / 70g / 80g台",
    torque: 3.2,
    tipStiffness: 82,
    midStiffness: 78,
    ...
    speedRange: [44, 56],
    trajectory: "フェード寄り",
    comment: "カウンターバランス系として、重めヘッドでも叩きやすい診断用設定。",
    sourceName: "Mitsubishi Chemical TENSEI Pro Orange 1K",
    sourceUrl: "https://www.mitsubishichemicalgolf.jp/products/detail/?product_id=20",
  },
  {
    name: "TENSEI Pro Black 1K Core",
    weight: "50g / 60g / 70g / 80g台",
    torque: 3.0,
    tipStiffness: 90,
    midStiffness: 84,
    ...
    speedRange: [46, 58],
    trajectory: "フェード寄り",
    comment: "強い入力で球を抑えたい上級者向けの診断用ハード設定。",
    sourceName: "Mitsubishi Chemical TENSEI Pro Black 1K Core",
    sourceUrl: "https://www.mitsubishichemicalgolf.jp/products/detail/?product_id=45",
  },
  {
    name: "TENSEI Pro Red 1K",
    weight: "40g / 50g / 60g台",
    torque: 3.9,
    tipStiffness: 62,
    midStiffness: 66,
    ...
    speedRange: [36, 47],
    trajectory: "ドロー寄り",
    comment: "高さとつかまりを出してキャリーを確保する診断用設定。",
    sourceName: "Mitsubishi Chemical TENSEI",
    sourceUrl: "https://www.mitsubishichemicalgolf.jp/products/series/?id=3",
  },
  {
    ...
    speedRange: [31, 43],
    trajectory: "ドロー寄り",
    comment: "軽量帯で振り切りやすく、キャリーを伸ばす方向の診断用設定。",
    sourceName: "Mitsubishi Chemical VANQUISH VV",
    sourceUrl: "https://www.mitsubishichemicalgolf.jp/products/detail/?product_id=44",
  },
  {
    name: "LIN-Q Blue EX",
    weight: "50g / 60g / 70g台",
    ...
    speedRange: [41, 53],
    trajectory: "ニュートラル",
    comment: "中弾道・低スピン寄りで、安定感を重視する診断用設定。",
    sourceName: "UST Mamiya LIN-Q",
    sourceUrl: "https://www.ustmamiya.com/lin-q-shafts/",
  },
  {
    name: "LIN-Q White EX",
    weight: "50g / 60g / 70g台",
    ...
    speedRange: [45, 57],
    trajectory: "フェード寄り",
    comment: "低打ち出し・低スピンで、左を嫌う人向けの診断用設定。",
    sourceName: "UST Mamiya LIN-Q",
    sourceUrl: "https://www.ustmamiya.com/lin-q-shafts/",
  },
  {
  ...
  },
  {
    ...
    speedRange: [38, 52],
    trajectory: "ニュートラル",
    comment: "クセの少ない中調子として、まず基準にしやすい診断用設定。",
    sourceName: "UST Mamiya ATTAS",
    sourceUrl: "https://ustmamiya.co.jp/product/attas_king/",
  },
  {
    name: "ATTAS KING",
    weight: "40g / 50g / 60g / 70g台",
    ...
    speedRange: [36, 48],
    trajectory: "ドロー寄り",
    comment: "つかまりと高弾道を強めに補う診断用ATTAS設定。",
    sourceName: "UST Mamiya ATTAS KING",
    sourceUrl: "https://ustmamiya.co.jp/product/attas_king/",
  },
  {
    name: "ATTAS DAAAS",
    ...
    speedRange: [42, 54],
    trajectory: "フェード寄り",
    comment: "叩いても左へ行きにくい方向へ寄せた診断用ATTAS設定。",
    sourceName: "UST Mamiya ATTAS",
    sourceUrl: "https://ustmamiya.co.jp/wp/wp-content/themes/ustmamiya/assets/images/common/26_UST_Mamiya_catalog.pdf",
  },
  {
    name: "ATTAS 11",
    weight: "40g / 50g / 60g / 70g台",
    ...
    speedRange: [38, 51],
    trajectory: "ドロー寄り",
    comment: "中間のしなりでタイミングを取りやすい診断用設定。",
    sourceName: "UST Mamiya ATTAS",
    sourceUrl: "https://ustmamiya.co.jp/wp/wp-content/themes/ustmamiya/assets/images/common/26_UST_Mamiya_catalog.pdf",
  },
  {
    name: "Project X HZRDUS Smoke Black RDX",
    weight: "50g / 60g / 70g台",
    torque: 3.1,
    tipStiffness: 88,
    midStiffness: 82,
    ...
    speedRange: [45, 57],
    trajectory: "フェード寄り",
    comment: "海外系の低弾道・低スピン代表として扱う診断用ハード設定。",
    sourceName: "True Temper Project X",
    sourceUrl: "https://www.truetempersports.com/",
  },
  {
    name: "Project X HZRDUS Smoke Red RDX",
    weight: "50g / 60g / 70g台",
    torque: 3.6,
    tipStiffness: 66,
    midStiffness: 70,
    ...
    speedRange: [39, 51],
    trajectory: "ドロー寄り",
    comment: "高打ち出しを加えつつ、手元側の安定感を残す診断用設定。",
    sourceName: "True Temper Project X",
    sourceUrl: "https://www.truetempersports.com/",
  },
];
